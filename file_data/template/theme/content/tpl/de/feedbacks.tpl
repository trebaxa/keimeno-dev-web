    ...
    <table >
        <tbody>
            <tr>
                ...
                <td><input id="kname" size="38" name="FORM[kname]" value="<% $POST.FORM.kname %>" class="form-control" type="text" aria-label="Vorname, Nachname"></td>
            </tr>
            <tr>
                <td>Ihre Emailadresse:</td>
                <td><input id="tschapura" size="38" name="FORM[tschapura]" value="<% $POST.FORM.tschapura %>" class="form-control" type="text" aria-label="Ihre Emailadresse"></td>
            </tr>
            <tr>
                <td colspan="2">Ihre Nachricht:<br>
                <textarea class="form-control"  rows="15" cols="46" name="FORM[feedback]" aria-label="Ihre Nachricht"><% $POST.FORM.feedback%></textarea></td>
            </tr>
         ...
         <tr>
                ...
                {LBL_CODEENTER}:<input size="6" name="securecode" class="form-control" type="text" aria-label="{LBL_CODEENTER}"></td>
            </tr>
            <%/if%>
        </tbody>
    </table>
